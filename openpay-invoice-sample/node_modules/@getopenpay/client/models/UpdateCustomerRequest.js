...
exports.instanceOfUpdateCustomerRequest = instanceOfUpdateCustomerRequest;
exports.UpdateCustomerRequestFromJSON = UpdateCustomerRequestFromJSON;
exports.UpdateCustomerRequestFromJSONTyped = UpdateCustomerRequestFromJSONTyped;
exports.UpdateCustomerRequestToJSON = UpdateCustomerRequestToJSON;
exports.UpdateCustomerRequestToJSONTyped = UpdateCustomerRequestToJSONTyped;
 ...
 */
function instanceOfUpdateCustomerRequest(value) {
    return true;
}
function UpdateCustomerRequestFromJSON(json) {
    return UpdateCustomerRequestFromJSONTyped(json, false);
}
function UpdateCustomerRequestFromJSONTyped(json, ignoreDiscriminator) {
    if (json == null) {
        return json;
    }
    return {
...
function UpdateCustomerRequestToJSON(json) {
    return UpdateCustomerRequestToJSONTyped(json, false);
}
function UpdateCustomerRequestToJSONTyped(value, ignoreDiscriminator = false) {
    if (value == null) {
        return value;
    }
    return {
